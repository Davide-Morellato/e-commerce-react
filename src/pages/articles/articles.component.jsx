...
import { useDispatch, useSelector } from "react-redux"; //importo l'HOOK per smistare le azioni
...
const Articles = () => {
  ...
  //dichiaro una variabile in cui salvare il selettore di articoli (creata in articles.selectors.js)
